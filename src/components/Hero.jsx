        ...
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
            ...
            <div className="lg:pr-12 xl:pr-20 self-start">
              <h2 className="font-sans text-4xl md:text-6xl font-bold mb-6 text-left text-white">
            ...
            <div className="self-start flex flex-col items-center lg:items-end lg:pl-12 xl:pl-20">
              <div className="w-full lg:w-[640px] xl:w-[720px] h-[60vh] min-h-[420px] rounded-2xl overflow-hidden border border-white/20 bg-black/20 backdrop-blur-md">
            ...
            <div className="lg:col-span-2 mt-10">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="group bg-white/10 backdrop-blur-md text-white rounded-2xl p-8 border border-white/20 transition-all duration-500 hover:bg-white/20 hover:scale-[1.02] hover:shadow-2xl cursor-pointer">
                  ...
                  <p className="text-white/90 group-hover:text-white transition-colors duration-300">Modular units that transform waste into bioplastics at the source, eliminating transportation costs.</p>
                </div>
                <div className="group bg-white/10 backdrop-blur-md text-white rounded-2xl p-8 border border-white/20 transition-all duration-500 hover:bg-white/20 hover:scale-[1.02] hover:shadow-2xl cursor-pointer">
                  ...
                  <p className="text-white/90 group-hover:text-white transition-colors duration-300">Real-time optimization ensures consistent EcoForm® quality across all production units.</p>
                </div>
                <div className="group bg-white/10 backdrop-blur-md text-white rounded-2xl p-8 border border-white/20 transition-all duration-500 hover:bg-white/20 hover:scale-[1.02] hover:shadow-2xl cursor-pointer">
                  ...
                  <p className="text-white/90 group-hover:text-white transition-colors duration-300">Waste becomes feedstock - no virgin materials needed, dramatically reducing production costs.</p>
                </div>
              </div>
              <p className="mt-8 text-white font-bold text-lg text-center">
