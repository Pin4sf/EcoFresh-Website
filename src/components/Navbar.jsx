        ...
        <div className="flex items-center justify-between bg-white/80 backdrop-blur-md border-b border-black/10 shadow-sm px-4 py-2">
          ...
          <div className="hidden md:flex gap-3">
            <Button variant="cta" size="sm" asChild className="font-semibold">
              <a href="https://docs.google.com/presentation/d/12yjtNQnuhZZkTr1NPIfER--LK_buJwOF/edit?usp=drivesdk&ouid=115342461485325584335&rtpof=true&sd=true" target="_blank" rel="noopener noreferrer">Investor Deck</a>
            </Button>
            <Button variant="cta" size="sm" asChild className="font-semibold">
